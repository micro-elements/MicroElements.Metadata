...
{
    /// <summary>
    /// Default implementation of <see cref="Diagnostics.IMessageList{TMessage}"/>.
    /// </summary>
    /// <typeparam name="TMessage">Message type.</typeparam>
    public class MessageList<TMessage> : Diagnostics.IMessageList<TMessage>
    {
        /// <summary>
        /// Empty message list.
        /// </summary>
        ...
        /// <inheritdoc />
        public Diagnostics.IMessageList<TMessage> Add(TMessage message)
        {
            ThrowIfMessageIsNull(message);
        ...
        /// <inheritdoc />
        public Diagnostics.IMessageList<TMessage> AddRange(IEnumerable<TMessage> other)
        {
    ...
    {
        public static readonly Diagnostics.IMessageList<string> EmptyMessageList = MessageList<string>.Empty;
    }
}
