...
namespace MicroElements.Metadata.Formatting
{
    ...
    public interface IValueFormatter<T> : IValueFormatter
    {
        ...
        string? IValueFormatter.Format(object? value, Type? valueType)
        {
            ...
            // If value is null and the type can accept null let formatter to format it too.
    ...
    internal static class ValueFormatter
    {
        /// <summary>
        /// Gets target type.
        /// Treats null type and typeof(object) as type unknown (so it should be retrieved from <paramref name="value"/>).
        /// </summary>
