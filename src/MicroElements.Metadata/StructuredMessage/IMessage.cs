...
namespace MicroElements.StructuredMessage
{
    ...
    public class StructuredMessage :
        PropertyContainer<MessageSchema>,
        IMessage,
        ...
        ICompositeBuilder<StructuredMessage, KeyValuePair<string, object?>>
    {
        ...
        private IMutablePropertyContainer _propertyContainer;
        ...
        {
            _propertyContainer = new MutablePropertyContainer(sourceValues);
            ...
            IMessageTemplateRenderer? messageTemplateRenderer)
        {
            ...
            if (originalMessage != null)
            {
                ...
                if (canBeTemplatedMessage && properties != null)
                {
                    ...
                    var propertiesForTemplate = properties.Properties.AsReadOnlyDictionary();
        ...
        /// <inheritdoc />
        public DateTimeOffset Timestamp => _propertyContainer.GetValue(MessageSchema.Timestamp);

        /// <inheritdoc />
        public MessageSeverity Severity => _propertyContainer.GetValue(MessageSchema.Severity);

        /// <inheritdoc />
        public string OriginalMessage => _propertyContainer.GetValue(MessageSchema.OriginalMessage)!;

        /// <inheritdoc />
        public string? EventName => _propertyContainer.GetValue(MessageSchema.EventName);

        /// <inheritdoc />
        IReadOnlyCollection<KeyValuePair<string, object>> IMessage.Properties => _propertyContainer.AsReadOnlyList();

        /// <inheritdoc />
        public string FormattedMessage => _propertyContainer.GetValue(MessageSchema.FormattedMessage);
